...
- **Legends.** Six set battles built around the design's signature moments (the bell charge, the silent charge, the downwind run, the colossus duel, light wars, the Choir's mirrors), each with its story and lesson. Win for bronze; win losing fewer soldiers for silver and gold.
- **Chronicles.** Your record with each faction (battles and campaigns won, the fastest victory), your Legends medals, fourteen feats to earn, and every tale and saga Claude has told you, kept in the browser.
