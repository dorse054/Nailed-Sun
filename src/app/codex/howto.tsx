      ...
      <Section id="cx-h-campaign" title="The campaign">
        <Items
          items={[
            ...
            { name: 'Claude as counsel', desc: 'Played on claude.ai, Settings can let the AI factions take Claude’s advice: every other Toll each asks Claude, in character, whether to change its wars, treaties or plans, and envoys answer your proposals in their own words. Choices made on its advice are marked ✦ Claude in the chronicle.' },
          ]}
        />
        <p class="cx-note">
