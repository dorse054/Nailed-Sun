          ...
          <section>
            ...
            <p class="muted small">
              {claude === "refused"
                ...
                : "In a campaign, every other Toll each AI faction asks Claude to choose its wars, treaties and plans, in character, and envoys answer your proposals in their own words. Choices made on Claude's advice are marked ✦ Claude in the chronicle. It uses your Claude usage, and the scripted AI takes over whenever Claude is slow or unavailable."}
            </p>
          </section>
        )}
        <section>
